...
def give_basic_suggestion(sentiment):
    if sentiment == "Negative":
        return "⚠️ Please address the student's concerns."
...
# Page 2: Suggestions for teachers
    ...
    if st.session_state.df.empty:
        st.info("ℹ️ Please upload and process a file first.")
    else:
...
elif page == "✍️ Manual Feedback Entry":
    st.header("✍️ Enter Feedback Manually")
